...
public class mainMenu extends JFrame {
    ...
    public mainMenu(user user) {
        ...
        favoritesButton.addActionListener(e -> openFavorites(null));
    ...
    public void addFavoriteShop(favoriteShop shop) {
        this.favoriteShop = shop;
        setFavoriteShop(shop.getShopName() + " - " + shop.getShopAddress());
    }
